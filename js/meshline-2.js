...
function init() {
	...
	controls.keys = {
  LEFT: 52, //left arrow52 : // LEFT
  UP: 56, // up arrow56 : // UP
  RIGHT: 54, // right arrow54 : // RIGHT
  BOTTOM: 50 // down arrow50 : // DOWN
	}
	...
	var material = new THREE.MeshBasicMaterial( {color: 0xffffff, transparent:true, opacity:0.85} );
...
function onMouseDown(event) {
	geometry = new THREE.Geometry();
	material = new THREE.LineBasicMaterial( { color: 0x444444, linewidth: 1 } );
